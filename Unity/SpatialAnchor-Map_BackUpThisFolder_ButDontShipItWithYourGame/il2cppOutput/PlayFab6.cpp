...
IL_00db_1:
			...
			{// begin try (depth: 2)
				...
				}
				{
					...
					NullCheck(L_36);
					int32_t L_39;
					L_39 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(33 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_36, L_37, 0, ((int32_t)(((RuntimeArray*)L_38)->max_length)));
				}
...
IL_0150_1:
			...
			{// begin try (depth: 2)
				...
				NullCheck(L_52);
				NullCheck(L_48);
				VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(36 /* System.Void System.IO.Stream::Write(System.Byte[],System.Int32,System.Int32) */, L_48, L_50, 0, ((int32_t)(((RuntimeArray*)L_52)->max_length)));
				goto IL_0151_1;
			}// end try (depth: 2)
			catch(Il2CppExceptionWrapper& e)
			{
